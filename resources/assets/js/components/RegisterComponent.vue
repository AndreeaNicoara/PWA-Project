<template>
    ...
    <div class="text-center form-wrapper">
        ...
        <div id="lcsFormContent" style="width:600px" v-on:submit.prevent="submitRegister">
            <form id="signupForm" class="default-form" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" required id="inputFirstName" placeholder="First Name" v-model="form.first_name">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="last_name" required id="inputLastName" placeholder="Last Name" v-model="form.last_name">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" required id="inputUsername" placeholder="Username" v-model="form.username">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="password" name="password" required id="inputPassword" placeholder="Password" v-model="form.password">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="password" required name="password_confirmation" id="inputCpassword" placeholder="Confirm Password" v-model="form.password_confirmation">
                ...
                <p style="text-align:center; color: #fff;" @click="loginPage"><a>Back to Login</a></p>
...
<script>
    ...
    import SnackBar from './front/Global/SnackBar/SnackBar'
    import {
        mapActions,
        mapGetters
    } from "vuex";
    ...
    export default {
        ...
        methods: {
            ...
            submitRegister() {
                ...
                // store.dispatch('registerUser', { username: this.username, password: this.password })
