<template>
    ...
    <div class="text-center form-wrapper">
        ...
        <div id="lcsFormContent">
            <form id="loginForm" class="default-form" v-on:submit.prevent="submitLogin">
                <h1 id="litheader">PMS</h1>
                <h5 id="litheader" style="text-align:center;">PROJECT MANAGEMENT SYSTEM</h5>
                <div class="inset">
                    <div class="form-group">

                        <input type="text" name="username" id="Username" placeholder="Username" required autofocus v-model="username">
                ...
                <p style="text-align:center; color:#fff;" @click="registerPage"><a>Register</a></p>
...
<style  scoped>
    /* @import "../../../../public/system/css/login.css"; */
